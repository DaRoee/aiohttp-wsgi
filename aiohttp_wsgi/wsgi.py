...
class WSGIBodyReader:
    ...
    def __iter__(self):
        return asyncio.run_coroutine_threadsafe(self._request.content.readexactly(1), self._loop).result()
...
class WSGIHandler:
    ...
    async def handle_request(self, request):
        ...
        return await self._loop.run_in_executor(self._executor, WSGIRequest().run_application, self._application, request, environ, self._loop)
